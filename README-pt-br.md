...
<div align="center">
  <img src="./assets/img/animated-flame-01.gif" width="1.75%" align="left"/>  
    <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=32&duration=2800&pause=2000&color=A9FEF7&center=true&vCenter=true&width=940&lines=Oi%2C+eu+sou+Andesson+e+bem-vindo+ao+meu+perfil!" alt="Oi, eu sou Andesson e bem-vindo ao meu perfil! animado digitado" width="90%" align="middle"/>
...
-  👨‍💻 Sou um Profissional de Dados e Desenvolvedor de Backend apaixonado por transformar dados em insights valiosos e construir soluções robustas no backend.
-  🎓 Possuo uma sólida experiência em engenharia de dados, incluindo extração, transformação e análise de grandes conjuntos de dados, junto com um profundo conhecimento em desenvolvimento de backend, criando sistemas escaláveis e eficientes.
-  💼 Sou versátil no manuseio de diversas fontes de dados, implementação de governança e medidas de qualidade de dados, e tenho experiência na criação de arquiteturas de software robustas e confiáveis no backend.
...
### **Engenharia de Dados:**
- **Tecnologias de Manipulação:** Python (manipulação de dados, script e automação), SQL (consulta avançada e otimização de banco de dados).
- **Big Data e Ferramentas ETL/ELT:** Proficiência em Apache Spark, Hadoop, Apache Airflow, Apache Nifi e Talend.
- **Arquitetura de Dados:** Design e manutenção de data warehouses e data lakes.
- **Cloud e Armazenamento:** Experiência em AWS, GCP e Azure para gerenciamento de dados.
- **Visualização de Dados:** Proficiente em ferramentas como Tableau, Power BI e matplotlib.
  
### **Desenvolvimento de Backend:**
- **Construção de API e Lógica do Servidor:** Utilização de Java e Spring para construção de API e lógica do servidor.
- **Tecnologias e Frameworks Web:** Domínio em Bootstrap, jQuery, JavaScript, HTML5 e CSS3 para desenvolvimento web.
- **Soluções Robustas no Backend:** Desenvolvimento e implementação de soluções eficientes no backend.
- **Versatilidade em Linguagens:** Proficiência em PyTorch, Tidyverse, C, C++ e práticas de versionamento Git.

<div align="center">
  <h2 align="center">Contribuição</h2><br>
  
- ✨ Estou aberto a colaborações e oportunidades tanto em Engenharia de Dados quanto em Desenvolvimento de Backend. Se você tiver projetos nos quais posso contribuir com minhas habilidades, sinta-se à vontade para entrar em contato.

<img src="./assets/animated-flame-01.gif" width="16px" align="left"/>
<img src="./assets/animated-flame-01.gif" width="16px" align="right"/>

<div align="center">
  <h2> 🏆 Minhas Estatísticas no Github <img src="./assets/borderseparator.gif"/></h2><br>

  <img src="https://github-profile-trophy.vercel.app/?username=andessonreis&theme=radical&no-frame=false&no-bg=true&row=1&column=-1" width="100%" alt="Troféu" align="middle" /> <br><h2></h2><br>
...
/badge/Spark-E25A1C?style=for-the-badge&logo=apache-spark&logoColor=white" />
...
<div align="center">
  ...
  <h2 align="center">👨‍💻 Projetos <img src="./assets/img/borderseparator.gif"/></h2><br>
...
<div align="center">
  <h2 align="center">Contato <img src="./assets/img/borderseparator.gif"/></h2><br>
  ...
  <a href="https://www.linkedin.com/in/andesson-reis" target="_blank"><img src="https://img.shields.io/badge/-LinkedIn-%230077B5?style=

for-the-badge&logo=linkedin&logoColor=white" target="_blank"></a> 
